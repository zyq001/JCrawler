 ...
 * @author hu
 */
public class DogoNewsCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public DogoNewsCrawler(String crawlPath) {
        super(crawlPath);

        regexRule.addRule("http://www.dogonews.com/.*");
...
static int conter = 1;
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new DogoNewsExtractor(page);
...
//                    System.out.println(conter++);
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        DogoNewsCrawler crawler = new DogoNewsCrawler("data/BBC");
        crawler.setThreads(3);
//        crawler.addSeed("http://www.bbc.com/culture/story/20160112-what-i-learned-when-i-lived-as-david-bowie");

        crawler.addSeed("http://www.dogonews.com/");

        crawler.addSeed("http://www.dogonews.com/page/2");
        crawler.addSeed("http://www.dogonews.com/page/3");
        crawler.addSeed("http://www.dogonews.com/page/4");
        crawler.addSeed("http://www.dogonews.com/page/5");
        crawler.addSeed("http://www.dogonews.com/page/6");
        crawler.addSeed("http://www.dogonews.com/page/7");
        crawler.addSeed("http://www.dogonews.com/page/8");
        crawler.addSeed("http://www.dogonews.com/page/9");
        crawler.addSeed("http://www.dogonews.com/page/10");
//        crawler.addSeed("http://www.dogonews.com/2015/11/11/scientists-say-being-hangry-is-normal-and-perhaps-even-genetic");
