 ...
 */
@CommonsLog
public class Top10GeographicExtractor extends BaseExtractor {

    public Top10GeographicExtractor(Page page) {
        super(page);
    }

    public Top10GeographicExtractor(String url) {
        super(url);
    }
    ...
    public boolean init() {
        ...
        try {
            ...
            SoupLang soupLang = new SoupLang(SoupLang.class.getClassLoader().getResourceAsStream("Top10GeographicRule.xml"));
