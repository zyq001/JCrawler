 ...
 * @author hu
 */
public class EconomistCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public EconomistCrawler(String crawlPath) {
        super(crawlPath);
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new EconomistExtractor(page);
...
//            String newStr = key + "=" + map.get(key);
//            set.add(newStr);
//        }
//
//        System.out.println(set);

        EconomistCrawler crawler = new EconomistCrawler("data/Economist");
        crawler.setThreads(1);
//        crawler.addSeed("http://www.wikihow.com/Accept-Criticism-While-at-Work");
        crawler.addSeed("http://www.economist.com/news/finance-and-economics/21679256-trouble-most-celebrated-investment-bank-emerging-markets-deep-impact");
...
//        crawler.addSeed("http://www.wikihow.com/Category:Youth");
        ...
        requester.setUserAgent("Mozilla/5.0 (X11; Linux i686; rv:34.0) Gecko/20100101 Firefox/33.0");
