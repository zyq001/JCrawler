 ...
 * @author hu
 */
public class SCMPCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public SCMPCrawler(String crawlPath) {
        super(crawlPath);

        regexRule.addRule("http://www.scmp.com/.*");
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new SCMPExtractor(page);
...
//        AntiAntiSpiderHelper.defaultUserAgent(requester);
        requester.setUserAgent("Mozilla/5.0 (X11; Linux i686; rv:35.0) Gecko/20100101 Firefox/35.0");
