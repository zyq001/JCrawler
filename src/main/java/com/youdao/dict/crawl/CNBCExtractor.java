 ...
 */
@CommonsLog
public class CNBCExtractor extends BaseExtractor {

    public CNBCExtractor(Page page) {
        super(page);
    }

    public CNBCExtractor(String url) {
        super(url);
    }
    ...
    public boolean init() {
        log.debug("*****init*****");
        try {
            SoupLang soupLang = new SoupLang(SoupLang.class.getClassLoader().getResourceAsStream("CNBCRule.xml"));
