 ...
 */
@CommonsLog
public class NewsCanadaCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public NewsCanadaCrawler(String crawlPath) {
        super(crawlPath);

        regexRule.addRule("http://www.newscanada.com/.*");
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new NewsCanadaExtractor(page);
...
//        log.info("Before return nextLinks");
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        NewsCanadaCrawler crawler = new NewsCanadaCrawler("data/NewsCanada");
        crawler.setThreads(3);
//        crawler.addSeed("http://www.wikihow.com/Become-a-Wine-Maker");
        crawler.addSeed("http://www.newscanada.com/en-Articles");
