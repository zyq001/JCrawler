 ...
 */
@CommonsLog
public class JpostExtractor extends BaseExtractor {

    public JpostExtractor(Page page) {
        super(page);
    }

    public JpostExtractor(String url) {
        super(url);
    }
    ...
    public boolean init() {
        log.debug("*****init*****");
        try {
            SoupLang soupLang = new SoupLang(SoupLang.class.getClassLoader().getResourceAsStream("JpostRule.xml"));
