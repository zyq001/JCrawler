 ...
 * @author hu
 */
public class CNBCCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public CNBCCrawler(String crawlPath) {
        super(crawlPath);

        regexRule.addRule("http://www.cnbc.com/.*");
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new CNBCExtractor(page);
...
////
            ...
            crawler.addSeed("http://www.cnbc.com/the-pulse/");
