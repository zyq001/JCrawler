 ...
 * @author hu
 */
public class VOANewsCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public VOANewsCrawler(String crawlPath) {
        super(crawlPath);

        regexRule.addRule("http://learningenglish.voanews.com/.*");
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new VOANewsExtractor(page);
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        VOANewsCrawler crawler = new VOANewsCrawler("data/VOANews");
...
//        crawler.addSeed("http://learningenglish.voanews.com/content/can-fish-teach-humans-to-regrow-teeth/3020452.html");
        crawler.addSeed("http://learningenglish.voanews.com/");
