...
import com.youdao.dict.util.SeleniumHttpRequester;
 ...
 */
@CommonsLog
public class Top10GeographicCrawler extends DeepCrawler {

    RegexRule regexRule = new RegexRule();

    JdbcTemplate jdbcTemplate = null;

    public Top10GeographicCrawler(String crawlPath) {
        super(crawlPath);
...
//                    "eadonline4nb", "new1ife4Th1sAugust", 5, 30);
    ...
    public Links visitAndGetNextLinks(Page page) {
        try {
            BaseExtractor extractor = new Top10GeographicExtractor(page);
